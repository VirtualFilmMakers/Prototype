...
#include "D_ReplaySpectatorPawn.generated.h"

/**
 * 
 */
UCLASS()
class VFM_PROTO_API AD_ReplaySpectatorPawn : public APlayerController
{
	GENERATED_BODY()
	
	AD_ReplaySpectatorPawn(const FObjectInitializer& ObjectInitializer);
